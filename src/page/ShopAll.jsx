      ...
      >
        ...
        <div className="w-full grid grid-cols-4 gap-y-10 gap-x-5 justify-items-stretch items-center">
          {filteredData.map((shopAll) => (
            <div
              key={shopAll.id}
              className="relative flex flex-col justify-center items-start gap-1 bg-gray-50 pb-2 rounded-b-[22px]"
            >
              {/* Image */}
              ...
              <button
                ...
                className={`absolute right-0.5 bottom-0.5 h-10 px-10 flex justify-center items-center rounded-full text-sm transition duration-200
                    ${
                      shopAll.stock === 0
